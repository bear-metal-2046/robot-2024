...
public class UnladenClimbCommand extends Command {
    ...
    public boolean isFinished() {
        return Math.abs(climbers.getLeftPosition() - position) < ClimberConstants.UNLADEN_POSITION_EPSILON
                && Math.abs(climbers.getRightPosition() - position) < ClimberConstants.UNLADEN_POSITION_EPSILON;
    }
}
